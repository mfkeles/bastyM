classdef Plotter < handle_light
    ...
    methods (Static)
        ...
        function initiatePlot(fontsize,color,fontName)

            if color == 'k'
                axes('NextPlot','add','FontSize',fontsize,'TickDir','out','FontName',fontName,'Color','k',...
                    'XColor','w',...
                    'YColor','w',...
                    'ZColor','w')
                set(gcf,'color','k')
            else
                axes('NextPlot','add','FontSize',fontsize,'TickDir','out','FontName',fontName,'Color','w',...
                    'XColor','k',...
                    'YColor','k',...
                    'ZColor','k')
                set(gcf,'color','w')
